...
const VacationPlanner2026 = () => {
  ...
  const holidays: { [key: string]: string } = {
    ...
    '2026-01-09': 'Перенесенный выходной (3 янв)',
    '2026-01-11': 'Новогодние каникулы',
    '2026-02-21': 'Перенесенный выходной (4 янв)',
    '2026-02-22': 'Перенесенный выходной (4 янв)',
    '2026-02-23': 'День защитника Отечества',
    '2026-03-07': 'Перенесенный выходной (8 мар)',
    '2026-03-08': 'Международный женский день',
    '2026-03-09': 'Перенесенный выходной (8 мар)',
    '2026-05-01': 'Праздник Весны и Труда',
    '2026-05-02': 'Перенесенный выходной (1 мая)',
    '2026-05-03': 'Перенесенный выходной (1 мая)',
    '2026-05-09': 'День Победы',
    '2026-05-10': 'Перенесенный выходной (9 мая)',
    '2026-05-11': 'Перенесенный выходной (9 мая)',
    '2026-06-12': 'День России',
    '2026-06-13': 'Перенесенный выходной (12 июн)',
    '2026-06-14': 'Перенесенный выходной (12 июн)',
    '2026-11-04': 'День народного единства',
    '2026-12-31': 'Перенесенный выходной (4 янв)'
  };
        ...
        <div className="w-96">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 text-xs text-gray-500 space-y-1">
              ...
              <p>• Праздников: 25 дней (включая переносы)</p>
              <p>• Сокращенных дней: 4 дня</p>
            </div>
          </div>
